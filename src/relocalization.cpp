...
ReLocalization::ReLocalization(const std::string& map_path):
    ...
    icp_.setEuclideanFitnessEpsilon (1e-12);
}
...
bool ReLocalization::reLocalization(const pcl::PointCloud<pcl::PointXYZINormal>::Ptr in,
    ...
    std::cout << "Initial pose in ReLocalization::reLocalization: " << initial_pose_ << std::endl;
    // pcl::PointCloud<pcl::PointXYZINormal>::Ptr tmp_cloud(new pcl::PointCloud<pcl::PointXYZINormal>);
    // pcl::transformPointCloud(*in, *tmp_cloud, initial_pose_);
    // pcl::io::savePCDFileBinaryCompressed("/home/amov/PersonalData/Program/Ros/Fastlio_localization_ws/data/initial.pcd", *tmp_cloud);
	...
	this->voxel_filter_.filter(*current_scan);
        ...
        // pcl::transformPointCloud(*in, *tmp_cloud, pos_inv);
        // pcl::io::savePCDFileBinaryCompressed("/home/amov/PersonalData/Program/Ros/Fastlio_localization_ws/data/after.pcd", *tmp_cloud);
